...
class mouselisc implements MouseListener {
	...
	public void mousePressed(MouseEvent e) {
		...
		if (b == MouseEvent.BUTTON2) {
			// System.out.println("middle mouse button pressed at " + x + "," +
			// y
			// + "\n");
		}
	...
	public void mouseReleased(MouseEvent e) {
		...
		if (b == MouseEvent.BUTTON2) {
			// System.out.println("middle mouse button released at " + x + "," +
			// y
			// + "\n");
		}
		if (b == MouseEvent.BUTTON3) {
			// System.out.println("right mouse button released at " + x + "," +
			// y
			// + "\n");
		}
