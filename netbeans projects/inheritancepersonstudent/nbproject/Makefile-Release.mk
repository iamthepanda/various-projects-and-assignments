...
${OBJECTDIR}/_ext/1962443507/dayOfYear.o: ../../School/CSC\ 340/inheritanc-person-student/dayOfYear.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1962443507/dayOfYear.o ../../School/CSC\ 340/inheritanc-person-student/dayOfYear.cpp

${OBJECTDIR}/_ext/1962443507/person.o: ../../School/CSC\ 340/inheritanc-person-student/person.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1962443507
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1962443507/person.o ../../School/CSC\ 340/inheritanc-person-student/person.cpp

${OBJECTDIR}/_ext/1962443507/personnel.o: ../../School/CSC\ 340/inheritanc-person-student/personnel.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1962443507
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1962443507/personnel.o ../../School/CSC\ 340/inheritanc-person-student/personnel.cpp

${OBJECTDIR}/_ext/1962443507/student.o: ../../School/CSC\ 340/inheritanc-person-student/student.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1962443507
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1962443507/student.o ../../School/CSC\ 340/inheritanc-person-student/student.cpp
