...
//----------db stuff----------
$db = new mysqli("localhost", "jabba", "supergng5");

if ($db->connect_error || !$db->select_db("student_jabba"))
{
...
/*$sql = "INSERT INTO images (filename, filename_s, filename_m, description) "
        . "VALUES ('" . $file . "', "
        . "'" . $fileName 
        . "_s" . "." . $imageType . "', "
        . "'" . $fileName
